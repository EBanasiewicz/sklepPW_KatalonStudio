...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Moje konto  sklep.pw.edu.pl/input__password'), 'wqcqnwt/cASRjDNn+bA+Fo8oXcmHnU8d')

WebUI.click(findTestObject('Object Repository/Page_Moje konto  sklep.pw.edu.pl/button_Zaloguj si'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Moje konto  sklep.pw.edu.pl/a_Wyloguj si'), 0)

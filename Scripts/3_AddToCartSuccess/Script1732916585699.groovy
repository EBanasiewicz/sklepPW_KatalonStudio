...
WebUI.click(findTestObject('Object Repository/Page_Wyniki wyszukiwania dla kubek  sklep.p_05c576/a_Zobacz koszyk'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Koszyk  sklep.pw.edu.pl/ProductInCartContainer'), 1)

WebUI.verifyElementText(findTestObject('Object Repository/Page_Koszyk  sklep.pw.edu.pl/a_Kubek PW'), 'Kubek PW')
